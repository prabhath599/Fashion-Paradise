  ...
  return (
    ...
    <>
          ...
          <li className="nav-item ">
            ...
            <li className="nav-item ">
              ...
              <NavLink
                ...
                className="nav-link active text-warning fw-bold"
      ...
      <div className="container ">
        ...
        <h1 className="text-center bg-light text-warning mt-4 fw-bold">
        ...
        <div className="dropdown text-end">
          ...
          <h6 className="text-start text-warning "><b>Total Products</b> : {product.length}</h6>
                  ...
                  <div className="card-body text-center p-1">
                    ...
                    <div className="text-center mb-3 mt-3">
                      ...
                      <button
                        ...
                        className="btn btn-success bg-dark text-warning"
